            ...
            <div class="card card-lg">
                ...
                <div class="card-body ">
                    <form action="{{ route('project.update', $project->language->id) }}" method="POST" id="aboutBoardForm"
                        ...
                        @method('PUT')
                        @csrf
                        <input type="text" value="{{ $project->language->id }}" name="lang_id" hidden>
                        <div class="row g-4">
                                ...
                                <div class="row mb-4">
                                    <div class="mb-3 col-6">
                                        ...
                                        <input type="text"
                                            ...
                                            name="page_title" value=" {{ old('page_des', $project->page_title) }}">
                                        @error('page_title')
                                    ...
                                    <div class="mb-3 col-6">
                                        ...
                                        <input type="text" class="form-control  @error('page_des') is-invalid @enderror"
                                            name="page_des" value=" {{ old('page_des', $project->page_des) }}">
                                        @error('page_des')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="mb-3 col-6">
                                        ...
                                        <input type="text" class="form-control  @error('paragraph') is-invalid @enderror"
                                            name="paragraph" value=" {{ old('page_des', $project->paragraph) }}">
                                        @error('paragraph')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
